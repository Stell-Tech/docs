...
<Note>
The [customer enrollment flow](/enrollment/how-enrollment-works) currently issues Apple Wallet passes only — Google Wallet passes are issued from the portal or via the API.
</Note>
