...
<Frame caption="The template from the editor, rendered on a real iPhone — with live values in place of the preview's placeholders.">
  <img src="/images/wallet/iphone-front.png" alt="The pass designed in the template editor, open in Apple Wallet on an iPhone" width="320" />
</Frame>
