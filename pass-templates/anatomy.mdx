...
<Frame caption="Logo and logo text top-left, a Member Tier header field top-right, the Balance primary field on the strip image, Member and Member Since on the shared field row, and the NFC tap icon bottom-right.">
  <img src="/images/wallet/iphone-front.png" alt="The front of a store card pass open in Apple Wallet on an iPhone, with the Hold Near Reader prompt below it" width="320" />
</Frame>
...
<Frame caption="The back of the same pass: your back fields (here Terms & Conditions and Customer Support) sit below the wallet's own controls, like automatic updates and notifications.">
  <img src="/images/wallet/iphone-back.png" alt="The back of a pass in Apple Wallet on an iPhone, showing wallet toggles followed by Terms & Conditions, Customer Support, and Serial Number back fields" width="320" />
</Frame>
...
![Store card layout: logo and header fields at the top, strip image with the primary field on it, secondary and auxiliary fields sharing one row, barcode at the bottom](/images/diagrams/pass-anatomy.svg)
