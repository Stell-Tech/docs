...
| "It says no compatible wallet is available" | The program doesn't support a wallet for the customer's device | Have them try from the device type suggested on screen. If the program should support that wallet, [contact Stell support](/support/contact) |
